...
function StudentDashboard(){
  ...
  const cancelEdit = ()=>{ setEditing(false); setForm({}); setActiveSection('profile'); }
        ...
        <div className="dashboard-body">
          <div className="dashboard-layout">
            <aside className="sidebar">
              ...
              <button className={activeSection==='edit'? 'sidebar-btn active' : 'sidebar-btn'} onClick={openEdit}>Edit Profile</button>
            </aside>
